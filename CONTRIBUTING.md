# Contributing to Royal

Being a fork of Monero and Aeon, Royal shares most of its codebase with Monero while making a few critical modifications such
...
request to Monero first, then send a corresponding PR to Royal by cherry-picking, as described above. If your Monero PR
is merged, your corresponding Royal PR will then be merged subsequently.

If you are to propose some changes that are specific to Royal and distinct from Monero, submit a pull request directly
to Royal and justify your changes by laying out how they are *more* or *uniquely* applicable to Royal. With a good
